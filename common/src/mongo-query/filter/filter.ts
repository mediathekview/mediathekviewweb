...
export type MongoFilter = WhereEvaluation | ComparisonOperator | LogicalOperator | ElementOperator | EvaluationOperator | ArrayOperator | BitOperator | { [key: string]: EqualType | EqualType[] }
