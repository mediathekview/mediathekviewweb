...
const searchEngine = new ElasticsearchSearchEngine('mediathekviewweb', 'entry', elasticsearchClient, ElasticsearchDefinitions.ElasticsearchSettings, ElasticsearchDefinitions.ElasticsearchMapping);
