...
const searchEngine = new ElasticsearchSearchEngine<Entry>('mediathekviewweb', 'entry', elasticsearchClient, ElasticsearchDefinitions.ElasticsearchSettings, ElasticsearchDefinitions.ElasticsearchMapping);
